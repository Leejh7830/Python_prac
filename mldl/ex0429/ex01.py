...
# = knr = KNeighborsRegressor() # neighbors 기본값 5
knr.fit(train_input, train_target)

value = knr.predict([[50]]) # 50, 100 같은 값이 나옴 (문제)
print(value)
...
value = lr.predict([[50]]) # 예측
print(value)

value = lr.predict([[1]]) # 예측
print(value)

value = lr.predict([[100]]) # 예측
print(value)
...
mytarget = np.column_stack( (mytrain**2,mytrain) )
